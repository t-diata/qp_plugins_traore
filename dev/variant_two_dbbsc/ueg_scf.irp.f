...
!
  END_DOC
  call ueg_create_guess
  call orthonormalize_mos
  call ueg_run
end

subroutine ueg_create_guess
  implicit none
  BEGIN_DOC
...
!   Run SCF calculation
  ...
  write(json_unit,json_array_open_fmt) 'ueg_scf'

  call ueg_Roothaan_Hall_SCF

  write(json_unit,json_array_close_fmtx)
  call json_close

  call ezfio_set_hartree_fock_energy(ueg_SCF_energy)
end
